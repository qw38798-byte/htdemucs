                ...
                if len(batch_data) >= batch_size or i >= mix.shape[1]:
                    ...
                    for j, (start, seg_len) in enumerate(batch_locations):
                        if mode == "generic":
                            ...
                            # print(result[..., start:start + seg_len])
                            # print(counter[..., start:start + seg_len])
                            # print(result[..., start:start + seg_len] / counter[..., start:start + seg_len])
                            # print("\n")
                        else:
